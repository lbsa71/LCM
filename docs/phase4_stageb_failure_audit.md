...
- [Frozen-probe records](../runs/phase4_stageb_factorial_v1/frozen_probe_records.json)
- [Frozen-probe summary](../runs/phase4_stageb_factorial_v1/frozen_probe_audit.json)
