...
- [Screen results](../evidence/records/phase26_contrast_coverage_v1/screen_results.json)
- [Screen analysis](../evidence/records/phase26_contrast_coverage_v1/screen_analysis.json)
- [Confirmation registration](../evidence/records/phase26_contrast_coverage_v1/confirmation/registration.json)
- [Confirmation results](../evidence/records/phase26_contrast_coverage_v1/confirmation/results.json)
- [Confirmation analysis](../evidence/records/phase26_contrast_coverage_v1/confirmation/analysis.json)
- [Read-only case-level failure audit](../evidence/records/phase26_contrast_coverage_v1/confirmation/failure_audit.json)
