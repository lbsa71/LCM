...
> **Archived decision record.** The recommendation below was superseded by the
> 2026-08-28 decision to pause model development. See the repository
> [README](../../README.md) for the current conclusion and
> [kill-test protocol](../kill_test.md) for the only proposed resumption path.
