...
> **Unrun, superseded proposal.** No training was launched from this note. The
> project is paused, and the only current resumption plan is the externally
> anchored [kill-test protocol](../kill_test.md).
