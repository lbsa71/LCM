...
- [Raw results](../evidence/records/breadth_reinforcement_v2/results.json)
- [Paired slopes and confidence intervals](../evidence/records/breadth_reinforcement_v2/analysis.json)
- [Split manifests](../evidence/records/breadth_reinforcement_v2/split_manifests.json)
