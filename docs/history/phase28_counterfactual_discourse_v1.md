...
- [Registration](../evidence/records/phase28_counterfactual_discourse_v1/registration.json)
- [Split manifests](../evidence/records/phase28_counterfactual_discourse_v1/split_manifests.json)
- [Raw results](../evidence/records/phase28_counterfactual_discourse_v1/screen_results.json)
- [Gate analysis](../evidence/records/phase28_counterfactual_discourse_v1/screen_analysis.json)
