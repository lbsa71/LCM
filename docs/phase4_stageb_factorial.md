...
- [Registration](../runs/phase4_stageb_factorial_v1/registration.json)
- [Split manifests](../runs/phase4_stageb_factorial_v1/split_manifests.json)
- [Raw screen results](../runs/phase4_stageb_factorial_v1/screen_results.json)
- [Gate and factorial analysis](../runs/phase4_stageb_factorial_v1/screen_analysis.json)
- [Case predictions](../runs/phase4_stageb_factorial_v1/case_predictions.json)
- [Frozen-probe audit](../runs/phase4_stageb_factorial_v1/frozen_probe_audit.json)
